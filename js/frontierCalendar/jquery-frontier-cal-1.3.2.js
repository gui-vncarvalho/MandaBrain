(function($) {
	 ...
	 */	
	function CalendarAgendaItem(title,acomodacao,startDate,endDate,allDay,hashData) {
		//alert(acomodacao);exit;
		...
		this.acomodacaoValue = acomodacao;
		// start date & time
		...
		this.getAcomodacao = function(){
			return this.acomodacaoValue;
		};
		...
		this.toString = function(){
			...
			s += "Acomodação: " + this.acomodacaoValue + "\n";
	...
	var jFrontierCalPlugin = function(
		 ...
		 *
		 */
		this.addAgendaItem = function(calId,title,acomodacao,startDate,endDate,allDay,data,displayProp){
			//alert(title);exit;
			if(calId != null && title != null && acomocadao != null && startDate != null && endDate != null && allDay != null){
				...
				var agi = new CalendarAgendaItem(title,acomodacao,startDate,endDate,allDay,hashData);
				if(displayProp != null){
